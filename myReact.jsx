...
//DEPLOYEMENT:
  ...
  //Vscode terminal: bash - cd project-folder. Follow all commands from GitHub.. git init, add ., status, commit -m "Mssg", branch, remote add, push...
  //Vscode terminal: 'npm install gh-pages --save-dev'
  //Update package.json with this line- "homepage": "https://yourusername.github.io/your-repository-name"
  //Update the scripts section by adding predeploy and deploy scripts:
    ...
    //Update your Vite config to handle relative asset paths.  In vite.config.js, add the following:
    // import { defineConfig } from 'vite';
    // export default defineConfig({
    //   base: '/MyRepositoryName/'
    // });
  //Vscode terminal Deploy Your App: Enter - npm run deploy
  //After the deployment is complete, app will be available at the homepage URL or on GitHub, on this project page, go to Settings, then Pages. Can also find the project deployment link there.
  
  //Update GitHub with local changes from vsc: On terminal(cd)
    //git status
    //git add .
    //git commit -m "Modified"
    //git push origin main
  //STOP DEPLOYMENT: Vscterminal: cd-project-folder. Enter "git push origin --delete gh-pages". Comment out predeploy and deploy in script pacakage.json file. Change the Source setting to None to stop using GitHub Pages.
